import{_ as e,W as a,X as s,a1 as n}from"./framework-673cca3a.js";const r={},i=n(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum grouplist
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="yum-dnf-rpm的比较" tabindex="-1"><a class="header-anchor" href="#yum-dnf-rpm的比较" aria-hidden="true">#</a> YUM|DNF|RPM的比较</h2><p>https://www.redhat.com/sysadmin/how-manage-packages</p>`,16),l=[i];function p(c,o){return a(),s("div",null,l)}const t=e(r,[["render",p],["__file","YUM.html.vue"]]);export{t as default};
