import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-d61d0f5e.js";const t={},p=e(`<h2 id="配置静态ip示例" tabindex="-1"><a class="header-anchor" href="#配置静态ip示例" aria-hidden="true">#</a> 配置静态IP示例</h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">network</span><span class="token punctuation">:</span>
