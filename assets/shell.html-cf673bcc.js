import{_ as l,W as v,X as a,Y as i,Z as s,$ as d,a1 as n,D as u}from"./framework-673cca3a.js";const r={},c=n(`<h1 id="_100个linux-shell脚本经典案例" tabindex="-1"><a class="header-anchor" href="#_100个linux-shell脚本经典案例" aria-hidden="true">#</a> 100个Linux Shell脚本经典案例</h1><p>1、编写hello world脚本</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#!/bin/bash
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,61);function p(h,q){const e=u("ExternalLinkIcon");return v(),a("div",null,[c,i("p",null,[i("a",m,[s("Docker+K8s+Jenkins 主流技术全解视频资料【干货免费分享】"),d(e)])]),t,i("p",null,[i("a",b,[s("Docker+K8s+Jenkins 主流技术全解视频资料【干货免费分享】"),d(e)])]),o])}const x=l(r,[["render",p],["__file","shell.html.vue"]]);export{x as default};
