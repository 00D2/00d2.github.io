import{_ as l,W as v,X as a,Y as i,Z as s,$ as d,a1 as n,D as u}from"./framework-f6ff4fa3.js";const r={},c=n(`<h1 id="_100个linux-shell脚本经典案例" tabindex="-1"><a class="header-anchor" href="#_100个linux-shell脚本经典案例" aria-hidden="true">#</a> 100个Linux Shell脚本经典案例</h1><p>1、编写hello world脚本</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#!/bin/bash
