import{_ as t,W as l,X as i,Y as n,Z as s,$ as e,a1 as p,D as c}from"./framework-673cca3a.js";const u={},o=p(`<h2 id="一、基本部署" tabindex="-1"><a class="header-anchor" href="#一、基本部署" aria-hidden="true">#</a> 一、基本部署</h2><h3 id="安装-ansible" tabindex="-1"><a class="header-anchor" href="#安装-ansible" aria-hidden="true">#</a> 安装 Ansible</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># yum -y install epel-release</span>
