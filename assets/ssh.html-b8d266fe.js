...
ProxyCommand <span class="token function">nc</span> --proxy-type http <span class="token parameter variable">--proxy</span> x.x.x.x:8081 %h %p
    ...
    ProxyCommand <span class="token function">nc</span> --proxy-type http <span class="token parameter variable">--proxy</span> x.x.x.x:8081 %h %p
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,9),r=[c];function t(o,d){return n(),e("div",null,r)}const p=s(i,[["render",t],["__file","ssh.html.vue"]]);export{p as default};
