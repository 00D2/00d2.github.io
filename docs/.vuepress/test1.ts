new Crawler({
    rateLimit: 8,
    startUrls: ["https://jinguo.tk"],
    renderJavaScript: false,
    sitemaps: ["https://jinguo.tk/sitemap.xml"],
    ignoreCanonicalTo: true,
    discoveryPatterns: ["https://jinguo.tk/**"],
    schedule: "at 2:26 PM on Tuesday",
    actions: [
      {
        indexName: "jinguo",
        pathsToMatch: ["https://jinguo.tk/docs/**"],
    ...
    appId: "AICWAHLPWU",
    apiKey: "d56f6744ab65445dc834a39642d860e2",
  });